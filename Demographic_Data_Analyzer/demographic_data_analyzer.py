...
def calculate_demographic_data(print_data=True):
    ...
    percentage_bachelors = round((total_bachelors/len(df))*100, 1)
    ...
    # count of people with salary >50K and higher education
    higher_education_rich_count = len(df[(df['education'].isin(['Bachelors', 'Masters', 'Doctorate'])) & (df['salary'] == '>50K')])

    # count of people with salary >50K and lower education
    ...
    lower_education_rich = round((lower_education_rich_count/lower_education)*100, 1)
    ...
    # Group the data by country and calculate the percentage of people earning >50K
...
# Find the country with the highest percentage of people earning >50K
    ...
    occupation_count = india_high_earners['occupation'].value_counts()
